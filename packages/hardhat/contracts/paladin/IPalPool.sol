...
interface IPalPool {
    ...
    function expandBorrow(address _loanPool, uint _feeAmount)
        external
        returns (uint);
    ...
    function changeBorrowDelegatee(address _loanPool, address _newDelegatee)
        external;
    ...
    function isLoanOwner(address _loanAddress, address _user)
        external
        view
        returns (bool);
    ...
    function getLoansByBorrower(address _borrower)
        external
        view
        returns (address[] memory);

    function getBorrowData(address _loanAddress)
        external
        view
        returns (
            address _borrower,
