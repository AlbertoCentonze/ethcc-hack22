...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  */
  ...
  console.log("impersonator generated");

  await aaveContract.balanceOf(YourContract.address);

  // const unsignedTx = await aaveContract.populateTransaction.transfer(ethers.provider.getSigner().address, 10);
  const unsignedTx = await aaveContract.populateTransaction.transfer(YourContract.address, 1000000);

  console.log("Tx generated");

  impersonatedSigner.sendTransaction(unsignedTx);
